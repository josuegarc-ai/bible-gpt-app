...
NOTE THAT PERSONA_QUESTIONS IS SUPPOSED TO REPLACE DIAGNOSTIC_QUESTIONS AS WELL
...
# ================================================================
# <<< BLOCK REPLACEMENT START >>>
# The entire old "Learn Module" (lines 1025-1555) is replaced by this new block.
# ================================================================
# LEARN MODULE (HYBRID: PERSONA ONBOARDING + 10-LEVEL PATH)
# ================================================================
def _learn_extract_json_any(response_text: str):
